...
<?php
    ...
    if ($_POST['submit']) {
       ...
       $sql = "UPDATE `problem` SET `status`='true' WHERE `p_id`= '".$_POST['id']."' ";
         mysqli_query($dbcon, $sql);
            ...
            $mail->AddAddress($_POST['p_email'], $_POST['p_name']); // to Address
            $mail->Send();
 
             echo "<script>";
             echo "alert('เรียบร้อย');";
             echo "window.location ='show_problem.php'; ";
             echo "</script>";
     }
      ...
      <div class="panel panel-info">
        <div style="padding-top:30px" class="panel-body">
          ...
          <form class="form-horizontal" action="show_problem_select.php" method="post">
            ...
            <input hidden type="text" value="<?php echo $row_problem['p_id'] ?>" name="id">
            <hr>
            <div class="form-group">
