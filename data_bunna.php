...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="text-center">แสดงข้อมูลส่วนตัวบรรณารักษ์</h3>
          <hr>
          ...
          <form class="form-horizontal" >
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-8">
                <a href="edit_bunna.php?id=<?php echo $session_id; ?>" class="form-control btn btn-success">แก้ไขข้อมูลส่วนตัว</a>
              </div>
            </div>
          </form>
        </div>
